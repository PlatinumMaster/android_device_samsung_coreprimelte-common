...
/**
 * RIL customization for Samsung Galaxy Core Prime LTE devices
 *
 * {@hide}
 */
public class CPRIL extends RIL implements CommandsInterface {
    ...
    public CPRIL(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
